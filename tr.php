<?php
    ...
    //Request Body//
    $body['product']    = array('Pengabdi Setan 2');
    $body['qty']        = array('4');
    $body['price']      = array('35000');
    $body['buyerName']  = "Hafiz";
    $body['buyerEmail'] = "hafizherla18@gmail.com";
    $body['buyerPhone'] = "081214893355";
    $body['returnUrl']  = 'http://localhost/projects/atol/tubes/return.php';
    $body['cancelUrl']  = 'http://localhost/projects/atol/tubes/index.php';
    $body['notifyUrl']  = 'http://localhost/projects/atol/tubes/index.php';
